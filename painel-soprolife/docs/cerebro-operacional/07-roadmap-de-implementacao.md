...
|---|---|---|
| **M9** | Briefing Diário real | snapshot diário persistido (gitignored) para "o que mudou" de verdade; briefing no topo do painel |
| **M10** | "Hoje eu tenho que fazer o quê?" | fila de decisão com feito/pendente (persistência leve), eixos de prioridade emitidos pelos geradores M4/M5 |
